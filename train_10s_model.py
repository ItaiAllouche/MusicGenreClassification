...
login(token='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', add_to_git_credential=True)
...
# %%
trainer.push_to_hub(output_model_name)
...
confusion_plot = sn.heatmap(confusion['eval_confusion_matrix'], annot=True, xticklabels=labels, yticklabels=labels).figure.savefig("output_10s.png")